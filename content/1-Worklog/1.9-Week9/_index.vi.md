...
| :--- | :--- | :--- | :--- | :--- |
| 20/07/2026 | Thứ 2 | - Tạo IAM Role ChatpulseEC2AppRole đính kèm Custom Policy cấp quyền giới hạn: s3:PutObject, s3:GetObject trên bucket media và ses:SendEmail trên verified identity.<br>- Gán IAM Role vào máy chủ EC2 qua Instance Profile.<br>- Xóa bỏ toàn bộ các biến môi trường AWS Access Key trong code backend; kiểm tra SDK tự động lấy thông tin xác thực từ EC2 Metadata Service qua IMDSv2. | Dự án Chatpulse: Bảo mật thông tin xác thực EC2 với IAM Roles và IMDSv2 | [IAM Roles for Amazon EC2](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/iam-roles-for-amazon-ec2.html) |
| 21/07/2026 | Thứ 3 | - Khởi tạo Web ACL trên AWS WAF gắn kết với CloudFront Distribution của dự án.<br>- Kích hoạt các bộ luật có sẵn của AWS: AWSManagedRulesCommonRuleSet và AWSManagedRulesKnownBadInputsRuleSet.<br>- Viết quy tắc Rate-based Rule: Giới hạn tối đa 300 requests trong vòng 5 phút trên mỗi IP nhằm ngăn chặn tấn công từ chối dịch vụ và hành vi spam tin nhắn. | Dự án Chatpulse: Bảo vệ tầng ứng dụng với AWS WAF và Rate Limiting | [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/) |
| 22/07/2026 | Thứ 4 | - Cấu hình CloudWatch Agent trên EC2 thu thập nhật ký từ thư mục log của PM2.<br>- Đẩy toàn bộ log lên CloudWatch Log Group aws/ec2/chatpulse/backend.<br>- Tạo Metric Filter tìm kiếm các chuỗi lỗi hoặc HTTP status 500 để phục vụ đo lường. | Dự án Chatpulse: Giám sát thời gian thực với CloudWatch Logs và Metric Filters | [CloudWatch Logs Filter and Pattern Syntax](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/FilterAndPatternSyntax.html) |
| 23/07/2026 | Thứ 5 | - Xây dựng quy trình tự động hóa CI/CD bằng GitHub Actions.<br>- Định nghĩa file cấu hình deploy: Thực hiện lint check, chạy unit tests, build source code và tự động deploy phiên bản mới lên EC2 và khởi động lại PM2.<br>- Kiểm tra commit thử nghiệm và xác nhận quy trình CI/CD chạy thành công. | Dự án Chatpulse: Xây dựng Automated CI/CD Deployment Pipeline | [GitHub Actions for AWS](https://aws.amazon.com/blogs/devops/deploy-to-amazon-ec2-using-github-actions/) |
| 24/07/2026 | Thứ 6 | - Sử dụng công cụ kiểm thử tải giả lập 200 người dùng đồng thời gửi tin nhắn WebSocket và gọi API liên tục.<br>- Quan sát phản ứng của hệ thống: AWS WAF chặn đứng các IP vượt ngưỡng rate limit và trả về mã lỗi 429 Too Many Requests; máy chủ EC2 giữ mức CPU ổn định dưới 45%.<br>- Tổng hợp số liệu và phân tích log bảo mật tuần 9. | Dự án Chatpulse: Kiểm thử tải và kiểm chứng năng lực phòng thủ của AWS WAF | [Stress Testing Web Applications](https://artillery.io/docs/) |
