...
### Mục tiêu tuần:
- Tinh chỉnh giao diện ứng dụng Chatpulse Frontend: tối ưu hóa hiển thị trên máy tính, thiết kế trải nghiệm nhắn tin mượt mà.
...
| :--- | :--- | :--- | :--- |
| 27/07/2026 | Thứ 2 | - Hoàn thiện giao diện Chatpulse Frontend: tối ưu thanh Sidebar hiển thị danh sách phòng chat và trạng thái trực tuyến.<br>- Đảm bảo giao diện hiển thị phù hợp trên trình duyệt máy tính. | [Dự án cuối kỳ](https://github.com/EricMai2112/chat-pulse) |
| 28/07/2026 | Thứ 3 | - Thiết lập kịch bản kiểm thử toàn diện:<br>+ Trường hợp 1: Đăng ký tài khoản mới, nhận OTP qua SES và kích hoạt tài khoản thành công.<br>+ Trường hợp 2: Đăng nhập cấp phát JWT, kết nối WebSocket qua Socket.io và gửi nhận tin nhắn văn bản tức thì.<br>+ Trường hợp 3: Tải ảnh avatar và tài liệu đính kèm định dạng PDF hoặc DOCX qua S3 Pre-signed URL.<br>+ Trường hợp 4: Xử lý tự động kết nối lại khi mạng bị ngắt. | [Dự án cuối kỳ](https://github.com/EricMai2112/chat-pulse) |
| 29/07/2026 | Thứ 4 | - Thiết lập hệ thống giám sát cảnh báo trên Amazon CloudWatch:<br>+ Cảnh báo khi mức sử dụng CPU của EC2 vượt 75% liên tục trong 10 phút.<br>+ Cảnh báo khi mức sử dụng bộ nhớ của ElastiCache vượt 80%.<br>- Kết nối các Alarm tới Amazon SNS Topic, cấu hình tự động gửi email thông báo khẩn cấp cho đội ngũ vận hành. | [Dự án cuối kỳ](https://github.com/EricMai2112/chat-pulse) |
| 30/07/2026 | Thứ 5 | - Thực hiện đóng gói mã nguồn phiên bản ổn định v1.0.0, gắn Git Tag trên repository.<br>- Viết tài liệu hướng dẫn vận hành chi tiết: các biến môi trường cấu hình, quy trình phục hồi khi gặp sự cố. | [Dự án cuối kỳ](https://github.com/EricMai2112/chat-pulse) |
| 31/07/2026 | Thứ 6 | - Tiến hành quay video demo hoạt động của dự án trên AWS và biên tập hoàn thiện video. Tổng kết tuần 10. | [Dự án cuối kỳ](https://github.com/EricMai2112/chat-pulse) |
